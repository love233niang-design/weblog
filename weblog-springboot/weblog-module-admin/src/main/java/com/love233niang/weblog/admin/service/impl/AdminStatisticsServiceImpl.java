...
public class AdminStatisticsServiceImpl implements AdminStatisticsService {
    ...
    public void statisticsCategoryArticleTotal() {
        ...
        // 查询所有文章-分类映射记录
        List<ArticleCategoryRelDO> articleCategoryRelDOS = articleCategoryRelMapper.selectList(null);
    ...
    public void statisticsTagArticleTotal() {
        ...
        // 查询所有文章-标签映射记录
        List<ArticleTagRelDO> articleTagRelDOS = articleTagRelMapper.selectList(null);
