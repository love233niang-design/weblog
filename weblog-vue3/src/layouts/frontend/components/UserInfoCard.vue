    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center  gap-2">
                <!-- GitHub -->
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" @click="jump(blogSettingsStore.blogSettings.githubHomepage)"
                    data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom" class="icon mt-5 w-7 h-7"
                ...
                <!-- Gitee -->
                <svg v-if="blogSettingsStore.blogSettings.giteeHomepage" t="1698030969736" @click="jump(blogSettingsStore.blogSettings.giteeHomepage)"
                ...
                <!-- 知乎 -->
                <svg v-if="blogSettingsStore.blogSettings.zhihuHomepage" t="1698031258903" @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)"
                ...
                <!-- CSDN -->
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586" @click="jump(blogSettingsStore.blogSettings.csdnHomepage)"
